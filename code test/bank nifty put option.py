...
input_folder_path = '/Users/abhijayjain/Desktop/internship/Indira Securities/4x trading/input /Option Files/BANK NIFTY/Put Option'

# New folder to save modified OHLC data
output_folder_path = '/Users/abhijayjain/Desktop/internship/Indira Securities/4x trading/Output files/bank nifty output/matching time data/put matching time'
...
folder_path = '/Users/abhijayjain/Desktop/internship/Indira Securities/4x trading/Output files/bank nifty output/matching time data/put matching time'

# Define the output folder path
output_folder = '/Users/abhijayjain/Desktop/internship/Indira Securities/4x trading/Output files/bank nifty output/trade entry point data/put trade entry point'
...
def is_trade_entry_point(open_time_4x, row):
    # Check if the high price is greater than or equal to the 4X open price
...
for filename in os.listdir(folder_path):
    if filename.endswith('.csv'):
        ...
        try:
            ...
            if not df.empty:
                first_open_price = df.iloc[0]['high']  # Get the first open price
...
folder_path = '/Users/abhijayjain/Desktop/internship/Indira Securities/4x trading/Output files/bank nifty output/trade entry point data/put trade entry point'
output_csv = '/Users/abhijayjain/Desktop/internship/Indira Securities/4x trading/Output files/bank nifty stats/bank nifty put stats/bank nifty put stats.csv'  # Output CSV file
